...
public enum BlockUserCommand implements Command {
    ...
    private static final String SUCCESS_BLOCK_PASS_ATTRIBUTE = "successBlockMessage";
    private static final String SUCCESS_LOGIN_EMAIL_MESSAGE = "User blocked";
    ...
    public CommandResponse execute(CommandRequest request) throws InterruptedException {
        ...
        request.addAttributeToJsp( SUCCESS_BLOCK_PASS_ATTRIBUTE, SUCCESS_LOGIN_EMAIL_MESSAGE);
