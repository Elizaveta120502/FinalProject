package com.epam.jwd.command.functions.lot;
...
public enum BuyLotCommand implements Command {
    ...
    private static final String BYU_JSP_PATH = "/WEB-INF/jsp/lot/buy.jsp";
    ...
    public CommandResponse execute(CommandRequest request) throws InterruptedException {
        ...
        request.addToSession(LOT_PARAM_NAME, boughtLot.get());
        return requestFactory.createRedirectResponse(BYU_JSP_PATH);
    }
