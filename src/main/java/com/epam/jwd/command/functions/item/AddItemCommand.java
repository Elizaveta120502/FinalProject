package com.epam.jwd.command.functions.item;
...
public enum AddItemCommand implements Command {
    ...
    private static final String SUCCESS_ITEM_CREATE_ATTRIBUTE = "successItemCreateMessage";
    private static final String SUCCESSFUL_CREATING_ITEM_MASSAGE = "Success!";
    ...
    public CommandResponse execute(CommandRequest request) throws InterruptedException {
        ...
        request.addAttributeToJsp(SUCCESS_ITEM_CREATE_ATTRIBUTE, SUCCESSFUL_CREATING_ITEM_MASSAGE);
