        ...
        <div class="add_lot_text">
            ...
            <div>
                <button class="create_lot_button">
                        ...
                        <span>Add
                            <br><img
                                    src="https://github.com/Elizaveta120502/PicturesFinalProject/blob/master/pictures/icon-daisy.png?raw=true">
                        </span>
            ...
            <c:if test="${not empty requestScope.successItemCreateMessage}">
                <b>${requestScope.successItemCreateMessage}</b>
                <br>
            </c:if>
        </div>
    </form>
